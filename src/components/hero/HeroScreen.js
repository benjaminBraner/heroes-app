...
import '../../styles/components/hero/HeroScreen.css'
...
export const HeroScreen = () => {
     ...
     return (
          <div className='HeroScreen'>
               <div className='hero-container animate__animated animate__backInLeft'>

                    <div className='hero-img-container'>
                         <img alt={superhero} src={heroImages(`./${id}.jpg`).default} />
                    </div>
